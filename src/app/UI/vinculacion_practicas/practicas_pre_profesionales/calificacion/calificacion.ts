...
export class CalificacionPracticas {
  ...
  private cargarElegibles() {
    this.http.get<Array<{ id_user: number; fullname: string; career_name?: string|null; career?: string|null; certificate_doc_id?: number|null; score?: number|null; status?: string|null }>>('/api/practicas/eligible')
      .subscribe(rows => {
