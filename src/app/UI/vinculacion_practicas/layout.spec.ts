...
import { VinculacionPracticasLayout } from './layout';
import { PeriodService } from '../../services/period.service';
import { AuthService, User } from '../../services/auth.service';

describe('VinculacionPracticasLayout', () => {
  let component: VinculacionPracticasLayout;
  let fixture: ComponentFixture<VinculacionPracticasLayout>;
  ...
  function createComponent() {
    fixture = TestBed.createComponent(VinculacionPracticasLayout);
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      imports: [VinculacionPracticasLayout],
      providers: [
        provideRouter([]),
      ...
      .overrideComponent(VinculacionPracticasLayout, { set: { template: '' } })
      .compileComponents();
  });
  ...
  it('should init from currentUserValue and map role + admin', () => {
    ...
    expect(component.userRole).toBe('Vinculación/Prácticas');
    expect(component.isAdmin).toBeTrue();
  });

  it('should map role as Usuario when role is missing/unknown and hasRole is false', () => {
    authMock.currentUserValue = {
      id_user: 1,
      email: 'x@x.com',
      firstname: 'Ana',
